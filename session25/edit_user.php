    ...
    <?php 
      ...
      if (isset($_POST['edit'])) {
        ...
        if ($name != '' && $email != '') {
          ...
          //
        	$sql = "UPDATE users SET name = '$name', email = '$email', phone = '$phone', avatar = '$avatar', gender = '$gender', city = '$city', birthday = '$birthday' WHERE id = $id";
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="#" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>
                    <input type="radio" name="gender" class="minimal" value="<?php echo $editUserDetail['male'];?>">Male
                  </label>
                  <label>
                    <input type="radio" name="gender" class="minimal" value="<?php echo $editUserDetail['female'];?>">Female
                  </label>
                  <label>
                    <input type="radio" name="gender" class="minimal" value="<?php echo $editUserDetail['other'];?>">Other
                </div>
              </div>
              <div class="form-group">
                <label>City</label>
                <select class="form-control select2" style="width: 100%;" name="city" value="">
                  <option value="<?php echo $editUserDetail['aa'];?>">Choose city</option>
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="birthday" class="form-control pull-right" id="birthday" value="<?php echo $editUserDetail['birthday'];?>">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.box-body -->
