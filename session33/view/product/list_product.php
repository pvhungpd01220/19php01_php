...
<section class="col-sm-9">
    ...
    <table class="col-sm-12" style="margin-top: 30px; background-color: white; width:100%;">
      <tr>
                                <td  style="color:red; font-size: 16px;width: 5%; height:40px; text-align:center;padding-top:10px; ">ID</td>
                                <td  style="color:red; font-size: 16px;width: 10%">Title</td>
                                <td style="color:red;font-size: 16px;width: 10%">description</td>
                                <td style="color:red;font-size: 16px;width: 12%">Image</td>
                                <td style="color:red;font-size: 16px;width: 12%">price</td>
                     ...
                     <?php 
                      ...
                      ?>
                        <tr>
                                ...
                                <td style="color:#020202;"><?php echo $row['title']?></td>
                                <td style="color:#020202;"><?php echo $row['description']?></td>
                                <td style="color:#020202;"><img src="webroot/uploads/<?php echo $row['image']?>" alt="image" class="avatar_user"></td>
                                <td style="color:#020202;"><?php echo $row['price']?></td>
