    ...
    <div class="container">
       <div class="form" style=" margin: auto; width:50%; height:300px;">
        <form action="admin.php?controller=user&action=add_user" method="POST" enctype="multipart/form-data">
            <h1 style="color: white;padding:10px; border-bottom: 1px solid #FFF">Add User</h1>
        ...
        <button type="submit" name="adduser" style="margin-bottom: 20px;margin-left:200px; "><a href="admin.php?controller=user&action=adduser">Add User</a></button>
  <p style="color: red"></p>
  </form>
        </div>
